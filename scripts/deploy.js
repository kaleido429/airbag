...
async function main() {
   ...
   * 
   */
  const UNISWAP_ROUTER = "0x0000000000000000000000000000000000000000"; // 🔄 Uniswap V2 Router
  const XRP_TOKEN = "0x0000000000000000000000000000000000000000";     // 🔄 ERC20 XRP 토큰 (mock 가능)
